...
public class RampagingGoat extends CustomEntity {
	...
	public RampagingGoat(Goat entity, Main plugin) {
		...
		if (entity.getCustomName() == null)
			entity.setCustomName(Languages.getString("easter.rampagingGoat"));
	...
	public void function(Iterator<CustomEntity> it) {
		...
		if (entity == null || entity.isDead()) {
			if (entity != null && entity.getKiller() != null && plugin.eventHandler.isEnabled && !plugin.eventHandler.eggs[2].hasAchieved(entity.getKiller().getUniqueId())) {
				CustomDropsFactory.generateDrops(entity.getLocation(), entityType, true);
				plugin.eventHandler.eggs[2].addProgress(entity.getKiller().getUniqueId(), 1);
			}
			it.remove();
			return;
		}
