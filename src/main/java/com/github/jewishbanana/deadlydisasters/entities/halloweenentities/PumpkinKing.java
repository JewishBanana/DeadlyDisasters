...
public class PumpkinKing extends CustomEntity {
	...
	public static boolean summonPumpkinKing(Main plugin, Block block) {
		...
		if (plugin.noteBlockAPIEnabled && (boolean) CustomEntityType.PUMPKINKING.grabCustomSetting("play_boss_music")) {
			...
			music.setVolume((byte) ((double) CustomEntityType.PUMPKINKING.grabCustomSetting("boss_music_volume") * 100.0));
