...
public class DarkMage extends CustomEntity {
	...
	public DarkMage(Mob entity, Main plugin) {
		...
		if (entity.getCustomName() == null)
			entity.setCustomName(Languages.getString("entities.darkMage"));
	}
	@Override
	public void tick() {
		if (entity == null)
	...
	public void function(Iterator<CustomEntity> it) {
		...
		if (entity.getTarget() != null && entity.getWorld().equals(entity.getTarget().getWorld()) && entity.getLocation().distanceSquared(entity.getTarget().getLocation()) <= 100) {
			cooldown = 7;
