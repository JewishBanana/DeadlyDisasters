package com.github.jewishbanana.deadlydisasters.entities.sandstormentities;
...
public class AncientSkeleton extends CustomEntity {
	...
	public AncientSkeleton(Mob entity, Main plugin, Random rand) {
		...
		if (entity.getCustomName() == null)
			entity.setCustomName(Languages.getString("entities.ancientSkeleton"));
	}
	@Override
	public void tick() {
		if (entity == null)
