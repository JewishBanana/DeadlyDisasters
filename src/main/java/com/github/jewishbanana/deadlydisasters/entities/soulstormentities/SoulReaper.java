package com.github.jewishbanana.deadlydisasters.entities.soulstormentities;
...
public class SoulReaper extends CustomEntity {
	...
	public SoulReaper(Mob entity, Main plugin, Random rand) {
		...
		vex.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(entityType.getDamage());
		...
		this.neutral = (boolean) entityType.grabCustomSetting("neutral_to_players");
		
		if (vex.getCustomName() == null)
			vex.setCustomName(Languages.getString("entities.soulReaper"));
	}
	@Override
	public void tick() {
