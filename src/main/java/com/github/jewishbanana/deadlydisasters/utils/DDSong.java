...
public class DDSong {
	...
	*/
	...
	public static DDSong CHRISTMAS_THEME = new DDSong(Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(0)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(12))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(10))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(10))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(10))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(17))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(12))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(17))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(17))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(18))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(17))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(10))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(10))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(12))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(12))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(12))), christmasTickRate(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(12))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(10))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(17))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(20))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(10))), christmasTickRate(2)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(15))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(12))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(13))), christmasTickRate(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_HARP, gfh(8))), christmasTickRate(40)));
	
	@SuppressWarnings("unchecked")
	public static DDSong EASTER_THEME = new DDSong(Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(1))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(5))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(1))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(1))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(10))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(9))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(8))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(1))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(5))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(1))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(1))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(8))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(5))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(11))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(11))), t(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(13))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(11))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(10))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(8))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(10))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(11))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(11))), t(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(15))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(13))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(11))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(10))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(8))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(8))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(5))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(3))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(1))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(5))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(5))), t(8)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(8))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(6))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(8))), t(4)), Pair.of(List.of(Pair.of(Sound.BLOCK_NOTE_BLOCK_BELL, gfh(10))), t(4)),
	...
	public DDSong(@SuppressWarnings("unchecked") Pair<List<Pair<Sound, Float>>,Integer>... list) {
