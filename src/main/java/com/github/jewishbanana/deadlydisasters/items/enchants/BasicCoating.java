...
public class BasicCoating extends com.github.jewishbanana.uiframework.items.UIEnchantment {
	...
	public static final List<Material> applicableTypes = Arrays.asList(Material.LEATHER_HELMET, Material.CHAINMAIL_HELMET, Material.IRON_HELMET, Material.GOLDEN_HELMET, Material.DIAMOND_HELMET, Material.NETHERITE_HELMET, Material.TURTLE_HELMET);
