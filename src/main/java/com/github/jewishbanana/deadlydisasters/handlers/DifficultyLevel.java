...
public enum DifficultyLevel {
    ...
    public static void reloadNames() {
    	EASY.setLabel(Utils.chat("&a&l"+Languages.getString("internal.easy")));
    	NORMAL.setLabel(Utils.chat("&e&l"+Languages.getString("internal.normal")));
    	HARD.setLabel(Utils.chat("&c&l"+Languages.getString("internal.hard")));
    	EXTREME.setLabel(Utils.chat("&4&l"+Languages.getString("internal.extreme")));
    	CUSTOM.setLabel(Utils.chat("&f&l"+Languages.getString("internal.custom")));
    }
}
