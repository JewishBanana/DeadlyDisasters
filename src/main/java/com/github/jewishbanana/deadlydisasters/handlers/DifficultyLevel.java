...
public enum DifficultyLevel {
    ...
    public static void reloadNames() {
    	EASY.setLabel(Utils.convertString("&a&l"+Languages.getString("internal.easy")));
    	NORMAL.setLabel(Utils.convertString("&e&l"+Languages.getString("internal.normal")));
    	HARD.setLabel(Utils.convertString("&c&l"+Languages.getString("internal.hard")));
    	EXTREME.setLabel(Utils.convertString("&4&l"+Languages.getString("internal.extreme")));
    	CUSTOM.setLabel(Utils.convertString("&f&l"+Languages.getString("internal.custom")));
    }
}
