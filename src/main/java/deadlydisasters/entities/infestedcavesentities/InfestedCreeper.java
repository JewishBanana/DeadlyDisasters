...
public class InfestedCreeper extends CustomEntity {
	...
	public InfestedCreeper(Creeper entity, Main plugin) {
		...
		if (entity.getCustomName() == null)
			entity.setCustomName(Languages.langFile.getString("entities.infestedCreeper"));
	...
	public void tick() {
		if (entity == null || stand == null)
			return;
		entity.getWorld().spawnParticle(Particle.BLOCK_CRACK, entity.getLocation().add(0,0.7,0), 10, .25, .4, .25, 0.1, data);
