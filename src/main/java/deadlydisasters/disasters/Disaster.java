...
public enum Disaster {
	...
	private double frequency,defaultRegenTickRate,regenTickRate;
    ...
    private Disaster(String label, double regenTickRate) {
        ...
        this.regenTickRate = regenTickRate;
    }
	...
	public void setRegenTickRate(double regenTickRate) {
		this.regenTickRate = regenTickRate;
	}
	...
	public static void reload(Main plugin) {
		for (Disaster obj : Disaster.values()) {
			if (plugin.getConfig().contains(obj.name().toLowerCase()+".regen_rate"))
				obj.setRegenTickRate(obj.getDefaultRegenTickRate() * plugin.getConfig().getDouble(obj.name().toLowerCase()+".regen_rate"));
