...
public class Languages {
	...
	public static String joinAfterUpdate = Utils.chat("&bUpdate log for &4&lV12.0 \n&3- A lot of new stuff \n-Hex color codes for disaster names support for spigot/paper/purpur \n- New disaster Infested Caves \n- New purge mobs \n- Revamped almost all weather disasters and tornados \n-Lots more config options \n-KingdomsX support \n- Lots of bug fixes \n-Tornados are still a bit buggy with the regen so its recommended to disable in places you don't want destroyed");
