							...
							breakthis:
								for (Disaster disaster : options) {
									...
									case PURGE:
										...
										break breakthis;
									case SOLARSTORM:
										if (!worldObj.allowed.contains(Disaster.SOLARSTORM) || loc.getBlockY() < Disaster.SOLARSTORM.getMinHeight() || world.getEnvironment() != Environment.NORMAL
										...
										break breakthis;
									case MONSOON:
										if (!worldObj.allowed.contains(Disaster.MONSOON) || loc.getBlockY() < Disaster.MONSOON.getMinHeight() || world.getEnvironment() != Environment.NORMAL
										...
										break breakthis;
									case INFESTEDCAVES:
										if (!worldObj.allowed.contains(Disaster.INFESTEDCAVES) || loc.getBlockY()+15 > plugin.getConfig().getInt("infestedcaves.max_height") || world.getEnvironment() != Environment.NORMAL)
											continue;
